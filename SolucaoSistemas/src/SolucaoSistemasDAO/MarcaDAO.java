...
public class MarcaDAO {
    ...
    public boolean CadastrarMarcaDAO() {
        try {
            ConectaBanco.ConectaPostgres();
            comando = "insert into marca (descricao, situacao) values(?,?)";
    ...
    public boolean AlterarMarcaDAO() {
        try {
            ConectaBanco.ConectaPostgres();
            comando = "update marca set descricao = ?, situacao = ? where codigo = ?";
            pst = ConectaBanco.con.prepareCall(comando, ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY);
    ...
    public ResultSet ConsultarMarcaDAO(){
        try {
            ConectaBanco.ConectaPostgres();
            comando = "select codigo, descricao, situacao from marca "

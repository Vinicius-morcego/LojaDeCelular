...
public class EspecieDAO {
    ...
    public boolean CadastrarEspecieDAO() {
        try {
            ConectaBanco.ConectaPostgres();
            comando = "insert into especie (descricao, situacao) values(?,?)";
    ...
    public boolean AlterarEspecieDAO() {
        try {
            ConectaBanco.ConectaPostgres();
            comando = "update especie set descricao = ?, situacao = ? where codigo = ?";
            pst = ConectaBanco.con.prepareCall(comando, ResultSet.TYPE_SCROLL_INSENSITIVE,
                    ResultSet.CONCUR_READ_ONLY);
    ...
    public ResultSet ConsultarEspecieDAO() {
        try {
            ConectaBanco.ConectaPostgres();
            comando = "select codigo, descricao, situacao from especie "
            ...
            System.out.println("Erro ao ConsultarEspecieDAO " + e.getMessage());
            return rs;
        }
    }
}
